...
const ContactFrom = () => {
  ...
  const formSubmit = (e) => {
    ...
    const newValue = { fname, lname, phone, email, subject, transport, message }
    ...
    <>
      <section className='contact mtop'>
        <div className='container flex'>
          <div className='main-content'>
            <h2>Contact From</h2>
            <p>Fill out the form below & Book your service in booking section, we will get back to you soon.</p>
      ...
      <section className='show-data'>
        {allValue.map((cureentValue) => {
          const { fname, lname, phone, email, subject, transport, message } = cureentValue
          return (
            <>
